...
alter table pizza_sales modify pizza_name_id varchar(50)
alter table pizza_sales modify order_date varchar(50)
alter table pizza_sales modify pizza_ingredients varchar(200)
...
select case when day(order_date) = 1 then 'Sunday'
...
when day(order_date) = 6 then 'Saturday'
...
select case when month(order_date) = 1 then 'Jan'
